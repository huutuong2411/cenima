...
class VNPay
{
     ...
     * config.php
     */
    public static $vnp_TmnCode = 'K5VUTKAL'; //Mã website tại VNPAY

    public static $vnp_HashSecret = 'IHBFKCKLAPXWTIKIIKWSWNGAVFJUDLXP'; //Chuỗi bí mật

    public static $vnp_Url = 'http://sandbox.vnpayment.vn/paymentv2/vpcpay.html';

    public static $vnp_Returnurl = '/order/VNPAY-check'; //Chú ý cấu hình env('APP_URL') khi sử dụng biến này.
