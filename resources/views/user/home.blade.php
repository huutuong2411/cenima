             ...
             <div class="row hero-area-slide">
                 <div class="col-lg-6 col-md-5 single-portfolio">
                     <div class="hero-area-content">
                         <img src="{{asset('/admin/assets/img/movies/'.$value->image)}}" alt="about" />
                         <a href="{{$value->trailer}}" class="popup-youtube">
                 ...
                 <div class="col-lg-6 col-md-7">
                     <div class="hero-area-content pr-50">
                         ...
                         <p>{!! \Illuminate\Support\Str::limit($value->description, 200, '...')!!}</p>
                         <h3>Diễn viên:</h3>
