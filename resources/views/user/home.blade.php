         ...
         <div class="hero-area-slider">
             <div class="row hero-area-slide">
                 <div class="col-lg-6 col-md-5 single-portfolio">
                     <div class="hero-area-content">
                         <img src="{{asset('user/assets/img/slide2.png')}}" alt="about" />
                     ...
                     <div class="hero-area-content pr-50">
                         ...
                         <div class="slide-cast">
                             <div class="single-slide-cast">
                                 <img src="{{asset('user/assets/img/cast/cast1.png')}}" alt="about" />
                             </div>
                             <div class="single-slide-cast">
                                 <img src="{{asset('user/assets/img/cast/cast2.html')}}" alt="about" />
                             </div>
                             <div class="single-slide-cast">
                                 <img src="{{asset('user/assets/img/cast/cast3.png')}}" alt="about" />
                             </div>
                             <div class="single-slide-cast">
                                 <img src="{{asset('user/assets/img/cast/cast4.png')}}" alt="about" />
                             </div>
                             <div class="single-slide-cast">
                                 <img src="{{asset('user/assets/img/cast/cast5.png')}}" alt="about" />
                             </div>
                             <div class="single-slide-cast">
                                 <img src="{{asset('user/assets/img/cast/cast6.png')}}" alt="about" />
                             </div>
                             <div class="single-slide-cast">
                                 <img src="{{asset('user/assets/img/cast/cast7.png')}}" alt="about" />
                             </div>
             ...
             <div class="row hero-area-slide">
                 <div class="col-lg-6 col-md-5">
                     <div class="hero-area-content">
                         <img src="{{asset('user/assets/img/slide1.png')}}" alt="about" />
                     </div>
                 </div>
                 <div class="col-lg-6 col-md-7">
                     <div class="hero-area-content pr-50">
         ...
         <div class="row">
             <div class="col-lg-9">
                 <div class="row portfolio-item">
                     <div class="col-md-4 col-sm-6 soon released">
                         <div class="single-portfolio">
                             <div class="single-portfolio-img">
                                 <img src="{{asset('user/assets/img/portfolio/portfolio1.png')}}" alt="portfolio" />
                                 <a href="https://www.youtube.com/watch?v=RZXnugbhw_4" class="popup-youtube">
                                     <i class="icofont icofont-ui-play"></i>
                                 </a>
                             </div>
                     ...
                     <div class="col-md-4 col-sm-6 top">
                         <div class="single-portfolio">
                             <div class="single-portfolio-img">
                                 <img src="{{asset('user/assets/img/portfolio/portfolio2.png')}}" alt="portfolio" />
                                 <a href="https://www.youtube.com/watch?v=RZXnugbhw_4" class="popup-youtube">
                                     <i class="icofont icofont-ui-play"></i>
                                 </a>
                             </div>
                     ...
                     <div class="col-md-4 col-sm-6 soon">
                         <div class="single-portfolio">
                             <div class="single-portfolio-img">
                                 <img src="{{asset('user/assets/img/portfolio/portfolio3.png')}}" alt="portfolio" />
                                 <a href="https://www.youtube.com/watch?v=RZXnugbhw_4" class="popup-youtube">
                                     <i class="icofont icofont-ui-play"></i>
                                 </a>
                             </div>
                     ...
                     <div class="col-md-4 col-sm-6 top released">
                         <div class="single-portfolio">
                             <div class="single-portfolio-img">
                                 <img src="{{asset('user/assets/img/portfolio/portfolio4.png')}}" alt="portfolio" />
                                 <a href="https://www.youtube.com/watch?v=RZXnugbhw_4" class="popup-youtube">
                                     <i class="icofont icofont-ui-play"></i>
                                 </a>
                             </div>
                     ...
                     <div class="col-md-4 col-sm-6 released">
                         <div class="single-portfolio">
                             <div class="single-portfolio-img">
                                 <img src="{{asset('user/assets/img/portfolio/portfolio5.png')}}" alt="portfolio" />
                                 <a href="https://www.youtube.com/watch?v=RZXnugbhw_4" class="popup-youtube">
                                     <i class="icofont icofont-ui-play"></i>
                                 </a>
                             </div>
                     ...
                     <div class="col-md-4 col-sm-6 soon top">
                         <div class="single-portfolio">
                             <div class="single-portfolio-img">
                                 <img src="{{asset('user/assets/img/portfolio/portfolio6.png')}}" alt="portfolio" />
                                 <a href="https://www.youtube.com/watch?v=RZXnugbhw_4" class="popup-youtube">
                                     <i class="icofont icofont-ui-play"></i>
                                 </a>
                             </div>
             ...
             <div class="col-lg-3 text-center text-lg-left">
                 <div class="portfolio-sidebar">
                     <img src="{{asset('user/assets/img/sidebar/sidebar1.png')}}" alt="sidebar" />
                     <img src="{{asset('user/assets/img/sidebar/sidebar2.png')}}" alt="sidebar" />
                     <img src="{{asset('user/assets/img/sidebar/sidebar3.png')}}" alt="sidebar" />
                     <img src="{{asset('user/assets/img/sidebar/sidebar4.png')}}" alt="sidebar" />
                 </div>
             </div>
         </div>
     </div>
         ...
         <div class="row">
             <div class="col-md-9">
                 <div class="video-area">
                     <img src="{{asset('user/assets/img/video/video1.png')}}" alt="video" />
                     <a href="https://www.youtube.com/watch?v=RZXnugbhw_4" class="popup-youtube">
                         <i class="icofont icofont-ui-play"></i>
                     </a>
             ...
             <div class="col-md-3">
                 <div class="row">
                     <div class="col-md-12 col-sm-6">
                         <div class="video-area">
                             <img src="{{asset('user/assets/img/video/video2.png')}}" alt="video" />
                             <a href="https://www.youtube.com/watch?v=RZXnugbhw_4" class="popup-youtube">
                                 <i class="icofont icofont-ui-play"></i>
                             </a>
                         </div>
                     ...
                     <div class="col-md-12 col-sm-6">
                         <div class="video-area">
                             <img src="{{asset('user/assets/img/video/video3.png')}}" alt="video" />
                             <a href="https://www.youtube.com/watch?v=RZXnugbhw_4" class="popup-youtube">
                                 <i class="icofont icofont-ui-play"></i>
                             </a>
                         </div>
