...
<h1 class="h3 mb-2 text-gray-800  border-bottom bg-white mb-4"><i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>Thêm phòng chiếu<a style="float:right;" href="" class="btn btn-danger col-1"><i class="fas fa-sharp fa-solid fa-arrow-left"></i> Quay lại</a></h1>
                                            ...
                                            <div class="receipt">
                                                    <div class="mb-3 row">
                                                        ...
                                                        <div class="col-2">
                                                            ...
                                                            <input readonly id="total_seat" name="total_payment" class="form-control" type="text" >
                                                        </div>       
                                                    </div>    
                                                    <hr class="primary"> 
...
//-------------------------Thêm ghế mỗi hàng   
        ...
        $(document).on('click','.addSeat', function(){    //sự kiện click thêm ghế
            ...
            $(this).closest('.card-body').find('.rowSeat').append(`<input type='text' class='btn ml-1' name='seat[${row}][]' value='${numberSeat}'>`);
            updateTotalSeats();
        });
