                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                ...
                                <form class="mx-1 mx-md-4" method="post" action="{{route('user.register_post')}}">
                                    @csrf
                                ...
                                <p class="mb-5 pb-lg-2" style="color: #393f81;">Do have an account? <a href="{{route('user.login')}}" style="color: #393f81;">Login here</a></p>
                                @if ($errors->any())
